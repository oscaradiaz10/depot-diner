...
<body>
    ...
    <div class="container-fluid">
        <img class="image-intro" src="media/img_0121-020522-121320.webp" alt="DD insde" width="100%" height="340">
    </div>

    <div class="container-fluid round-right">
        <div class="row align-items-center">
            <div class="col-md-6 col-sm-12">
                <img src="media/img_2603.webp" alt="Inspiration">
            </div>
    ...
    <div class="container-fluid round-left">
        <div class="row align-items-center">
            <div class="col-md-5 col-sm-12 justify-content-end">
            ...
            <div class="col-md-6 col-sm-12">
                <img src="media/img_5298-020522-121313.webp" alt="Hangar">
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid round-right">
        <div class="row align-items-center">
            <div class="col-md-6 col-sm-12">
                <img src="media/img_5298-020522-121313.webp" alt="Our Food">
            </div>
            <div class="col-md-5 col-sm-12 justify-content-end">
                ...
                <button class="btn btn-primary" type="button">See Our Menu</button>
            </div>
        </div>
    </div>
