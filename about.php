...
<body>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8 col-sm-12">
                <img class="about-img-left" src="media/img_2603.webp" alt="Inspiration">
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-8 col-sm-12">
                <img class="about-img-right" src="media/ariel-1.webp" alt="Hangar">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8 col-sm-12">
                <img class="about-img-left" src="media/shutterstock_581655208-lr.webp" alt="Our Food">
            </div>
            <div class="col-md-4 col-sm-12">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-8 col-sm-12">
                <img class="about-img-right" src="media/img_0123.webp" alt="Work">
            </div>
        </div>
    </div>
