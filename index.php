...
<body>
    ...
    <main class="container spacer-top text-center">
        <div class="row justify-content-center">
            ...
            if (time() <= mktime(23, 59, 59, 1, 19, 2026)) {
                echo '
                    <div class="alert alert-danger" role="alert" style="margin-bottom: 100px;">
                        <strong>We will be closed from January 5-19, 2026, for deep cleaning and staff training. We will reopen with regular hours on January 20, 2026.</strong>
                    </div>
                ';
            }
            ?>
    ...
    <div class="jumbotron contact-info">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h3>Hours</h3>
                    <p><strong>Monday - Saturday</strong><br />7:30 AM - 7:30 PM</p>
